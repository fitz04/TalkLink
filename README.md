...
* **🤖 Discord 연동**: Discord 봇을 통한 양방향 메시지 동기화 및 실시간 번역 지원
* **🌏 실시간 자동 번역**: 메시지 전송 시 수신자의 설정 언어로 즉시 번역 (OpenRouter 모델 선택 가능)
* **🔒 사용자 인증**: 회원가입, 로그인 및 JWT 기반 보안 인증
* **🎫 게스트 모드**: 초대 코드를 통한 간편한 익명 입장 및 자동 채팅방 연결
* **👥 채팅방 관리**: 자유로운 채팅방 생성 및 초대 관리
